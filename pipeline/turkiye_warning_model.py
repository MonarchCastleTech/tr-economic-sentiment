...
def main() -> None:
    ...
    if not available:
        output["meta"]["mode"] = "unavailable"
        output["warning"].update(score=None, raw_score=None, concurrence_bonus=None, status="UNAVAILABLE", headline="No source-backed economic-strain score is available.")
        output["history"] = old.get("history", [])[-60:]
